-- ========================================
-- CREATE APP_SETTINGS TABLE AND AUTO-APPROVE FIX
-- ========================================
-- This creates the app_settings table first, then applies the auto-approve fix
...
-- Step 5: Update the trigger with better error handling and logging
