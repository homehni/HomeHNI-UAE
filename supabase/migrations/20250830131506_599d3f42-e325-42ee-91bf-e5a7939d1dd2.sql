-- Insert sample content elements for the main website sections

-- First, delete any existing elements with these keys to avoid duplicates
DELETE FROM public.content_elements WHERE element_key IN (
  'mobile_app_section', 
  'stats_section', 
