...
-- Create updated function with owner phone number
...
-- Add comment
COMMENT ON FUNCTION public.get_property_owner_contact IS 
'Returns property owner contact information including email, name, and phone. Used when users contact property owners.';
