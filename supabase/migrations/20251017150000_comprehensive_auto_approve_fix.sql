...
-- This ensures auto-approve functionality works completely
...
-- Step 2: Update the trigger with better error handling
...
-- Step 3: Update all existing pending/new properties to approved
