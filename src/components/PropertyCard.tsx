...
const PropertyCard = ({
  ...
  return (
    <Card className="w-full max-w-48 sm:w-48 overflow-hidden card-border hover-lift cursor-pointer bg-white border-2 border-primary" onClick={() => navigate(`/property/${id}`, { state: propertyForPage })}>
