        ...
        <div className="w-full px-4 lg:px-6 xl:px-8 pt-[6px]">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Select>
                <SelectTrigger className={`w-28 sm:w-32 transition-all duration-500 [&>svg]:text-current ${
                  isScrolled 
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <Button 
                variant="outline" 
                size="sm"
                className={`font-medium px-2 sm:px-4 py-2 text-xs sm:text-sm transition-all duration-500 ${
                  isScrolled 
                    ? 'bg-white text-brand-red border-gray-300 hover:bg-gray-50' 
                    : 'bg-white text-brand-red border-white/50 hover:bg-white/90'
                }`}
              >
              ...
              <div className="hidden lg:flex items-center space-x-2">
                <Button variant="ghost" size="sm" className={`p-2 transition-colors duration-500 ${
                  isScrolled 
                    ? 'text-gray-800 hover:bg-gray-100' 
