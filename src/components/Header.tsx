        ...
        <div className="w-full px-4 lg:px-6 xl:px-8 pt-[6px]">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Location Selector - Hidden on Architects, Interior, Property Management, Painting Cleaning, and Packers Movers page */}
              {!isArchitectsPage && !isInteriorPage && !isPropertyManagementPage && !isPaintingCleaningPage && !isPackersMoversPage && (
                <Select>
              ...
              {/* Desktop Navigation Links - Hidden on Architects, Interior, Property Management, Painting Cleaning, and Packers Movers page */}
              {!isArchitectsPage && !isInteriorPage && !isPropertyManagementPage && !isPaintingCleaningPage && !isPackersMoversPage && <nav className="hidden lg:flex items-center space-x-5">
    ...
    {isServicesDropdownOpen && <div className="absolute top-full left-0 w-56 bg-white border border-gray-200 rounded-lg shadow-xl z-[60] mt-2" onMouseEnter={handleServicesHover} onMouseLeave={handleServicesLeave}>
     ...
     Jobs
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
               ...
               {/* Post Property Button - Hidden on Architects, Interior, Property Management, Painting Cleaning, and Packers Movers page */}
              ...
              {user && <DropdownMenu>
               ...
               {/* Sidebar toggle button - Hidden on Architects, Interior, Property Management, Painting Cleaning, and Packers Movers page */}
        ...
        {/* Sidebar Component - Hidden on Architects, Interior, Property Management, Painting Cleaning, and Packers Movers page */}
        {!isArchitectsPage && !isInteriorPage && !isPropertyManagementPage && !isPaintingCleaningPage && !isPackersMoversPage && <Sidebar isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} />}
