...
const Header = () => {
  ...
  // Check if current page is loans, architects, interior, handover-services, property-management, painting-cleaning, packers-movers, or careers page
        ...
        <div className="w-full px-4 lg:px-6 xl:px-8 pt-[6px]">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Location Selector - Hidden on Loans, Architects, Interior, Handover Services, Property Management, Painting Cleaning, Packers Movers, and Careers page */}
              {!isLoansPage && !isArchitectsPage && !isInteriorPage && !isHandoverServicesPage && !isPropertyManagementPage && !isPaintingCleaningPage && !isPackersMoversPage && !isCareersPage && (
                <Select>
              ...
              {/* Desktop Navigation Links - Hidden on Loans, Architects, Interior, Handover Services, Property Management, Painting Cleaning, Packers Movers, and Careers page */}
              {!isLoansPage && !isArchitectsPage && !isInteriorPage && !isHandoverServicesPage && !isPropertyManagementPage && !isPaintingCleaningPage && !isPackersMoversPage && !isCareersPage && <nav className="hidden lg:flex items-center space-x-5">
    ...
    {isServicesDropdownOpen && <div className="absolute top-full left-0 w-56 bg-white border border-gray-200 rounded-lg shadow-xl z-50 mt-2" onMouseEnter={handleServicesHover} onMouseLeave={handleServicesLeave}>
     ...
     Jobs
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
               {/* Phone Number - Only visible on Loans, Architects, Interior, Handover Services, Property Management, Painting Cleaning, Packers Movers, and Careers page */}
               ...
               {/* Post Property Button - Hidden on Loans, Architects, Interior, Handover Services, Property Management, Painting Cleaning, Packers Movers, and Careers page */}
              ...
              {user && <DropdownMenu>
               ...
               {/* Sidebar toggle button - Hidden on Loans, Architects, Interior, Handover Services, Property Management, Painting Cleaning, Packers Movers, and Careers page */}
       ...
       {/* Sidebar Component - Hidden on Loans, Architects, Interior, Handover Services, Property Management, Painting Cleaning, Packers Movers, and Careers page */}
       {!isLoansPage && !isArchitectsPage && !isInteriorPage && !isHandoverServicesPage && !isPropertyManagementPage && !isPaintingCleaningPage && !isPackersMoversPage && !isCareersPage && <Sidebar isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} />}
