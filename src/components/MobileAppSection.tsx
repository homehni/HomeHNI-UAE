        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center max-w-6xl mx-auto">
          ...
          <div className="hidden lg:flex justify-center lg:justify-end order-1 lg:order-2">
            <div className="relative">
              <img src={cmsContent?.content?.appImage || '/lovable-uploads/ee843ec7-81c8-4575-aff3-09a145035577.png'} alt="Home HNI mobile app preview" loading="lazy" className="w-full max-w-sm h-96" />
