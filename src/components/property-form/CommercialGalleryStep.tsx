...
// Define a local type for our commercial form data
...
export const CommercialGalleryStep: React.FC<CommercialGalleryStepProps> = ({
  ...
  const handleFormSubmit = (data: any) => {
    ...
    const propertyGalleryData: PropertyGallery = {
      ...
      categorizedImages: {
        ...
        hall: [],
        kitchen: [],
        frontView: data.images.frontView,
        balcony: [],
        others: [...data.images.interiorView, ...data.images.others]
      },
      video: data.video
    };
  ...
  const handleSubmitProperty = () => {
    ...
    const propertyGalleryData: PropertyGallery = {
      ...
      categorizedImages: {
        ...
        hall: [],
        kitchen: [],
        frontView: currentFormData.images.frontView,
        balcony: [],
        others: [...currentFormData.images.interiorView, ...currentFormData.images.others]
      },
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
      <Form {...form}>
        <form id="commercial-gallery-form" onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-8">
          <FormField 
              ...
              <FormItem>
                <FormControl>
                  <div className="space-y-6">
                    {/* Upload Images Title */}
                    <div>
                      <h1 className="text-2xl font-semibold text-primary mb-6">Upload Commercial Property Images</h1>
                    </div>
      ...
      <button type="submit" form="commercial-gallery-form" className="hidden" />
    </div>
  );
};