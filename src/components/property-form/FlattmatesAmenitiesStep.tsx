      ...
      <Form {...form}>
        <form id={formId || 'flatmates-step-form'} onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-teal-600 mb-4">Room Details</h3>
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-teal-600 mb-4">Flatmate Preference</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Non-Veg Allowed */}
              <FormField
                control={form.control}
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-teal-600 mb-4">Additional Details for maximum visibility</h3>
