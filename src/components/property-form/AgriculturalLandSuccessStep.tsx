...
export const AgriculturalLandSuccessStep = ({
  ...
  const handleSendPhotos = () => {
    ...
    const message = encodeURIComponent(`Hi! I want to send photos for my agricultural land listing. Submission ID: ${createdSubmissionId || 'N/A'}`);
      ...
      <div className="text-center space-y-4 bg-green-50 border border-green-200 rounded-lg p-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-green-800 mb-2">
            Congratulations! Your Agricultural Land listing has been posted.
          </h2>
