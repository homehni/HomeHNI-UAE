  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Commercial Rental Details</h2>
        <p className="text-gray-600">Enter the rental-specific details for your commercial property</p>
      </div>
