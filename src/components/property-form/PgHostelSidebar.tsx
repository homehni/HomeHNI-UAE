...
const steps = [
  { id: 1, title: 'Room Types', description: 'Select room configurations', icon: Home },
  ...
  { id: 4, title: 'PG Details', description: 'Rules & preferences', icon: Star },
  { id: 5, title: 'Amenities', description: 'Services & facilities', icon: Star },
