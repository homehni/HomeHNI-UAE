...
export const AmenitiesStep: React.FC<AmenitiesStepProps> = ({
  ...
  const form = useForm<AmenitiesFormData>({
    ...
    defaultValues: {
      ...
      petAllowed: initialData.petAllowed === true,
      gym: initialData.gym === true,
      nonVegAllowed: initialData.nonVegAllowed === true,
      gatedSecurity: initialData.gatedSecurity === true,
      ...
      moreSimilarUnits: initialData.moreSimilarUnits === true,
