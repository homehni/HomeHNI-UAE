                                ...
                                <Popover open={openDropdown === 'construction'} onOpenChange={(open) => setOpenDropdown(open ? 'construction' : null)}>
                                  <PopoverTrigger asChild>
                                    <Button
                                      variant="outline"
                                      size="sm"
                                      className={`gap-2 px-5 py-2 rounded-lg border-2 overflow-hidden transition-all duration-200 hover:shadow-sm whitespace-nowrap ${openDropdown === 'construction' ? 'bg-blue-50 border-blue-400 shadow-sm' : 'border-gray-300 hover:border-gray-400'}`}
                                    >
