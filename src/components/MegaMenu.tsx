...
const MegaMenu = ({ onClose }: MegaMenuProps) => {
  ...
  return (
    <div className="absolute top-full left-0 w-[800px] bg-white border border-gray-200 rounded-lg shadow-xl z-50 mt-2">
      <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {[
                ...
                <a key={item} href="#" className="block text-sm text-gray-700 hover:text-brand-red transition-colors" onClick={onClose}>
                  {item}
                </a>
              ))}
            </div>
