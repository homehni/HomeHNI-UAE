...
const Marquee = () => {
  return (
    <div className="fixed top-0 left-0 right-0 bg-brand-red text-white py-2 overflow-hidden whitespace-nowrap z-50 group">
      <div className="animate-[marquee_150s_linear_infinite] group-hover:animate-none inline-block min-w-full">
