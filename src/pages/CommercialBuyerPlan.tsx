    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-brand-red text-white py-20 pt-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="bg-white/10 border border-white/20 rounded-lg p-6 mb-8 backdrop-blur-sm max-w-4xl mx-auto">
            <p className="text-lg md:text-xl font-semibold">
              <span className="text-red-300">NoBrokerage.</span> 
              <span className="text-yellow-300"> No Hidden Fees.</span> 
              <span className="text-white"> Just Expert Help — </span>
              <span className="text-green-300">FREE (for a limited time).</span>
            </p>
          </div>
          <Button 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            {plans.map((plan, index) => (
              <Card key={index} className={`relative ${plan.popular ? 'ring-2 ring-brand-red scale-105' : ''} hover:shadow-lg transition-all`}>
                {plan.popular && (
                  <Badge className="absolute -top-2 left-1/2 transform -translate-x-1/2 bg-brand-red text-white">
                    Most Popular
                  </Badge>
                )}
                <CardHeader className="text-center pb-2">
                  ...
                  <div className="mt-4">
                    <span className="text-2xl font-bold line-through text-muted-foreground">{plan.originalPrice}</span>
                    <div className="text-3xl font-bold text-green-600 mt-2">Currently FREE</div>
                  </div>
                </CardHeader>
                <CardContent className="pt-6">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 text-lg">
            Hear from satisfied clients who found their perfect commercial spaces
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-center text-muted-foreground mb-12 text-lg">
            Get answers to common questions about our commercial buyer plans
          </p>
