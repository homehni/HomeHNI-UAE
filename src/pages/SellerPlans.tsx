...
const SellerPlans: React.FC = () => {
  const plans = [
    ...
    },
    {
      ...
      features: [
        "All Relax Plan benefits",
        "Field Assistant shows property on your behalf",
        "Facebook marketing of your property",
        "Relationship Manager for follow-ups"
      ],
    ...
    },
    {
      ...
      features: [
        "Guaranteed buyer leads or refund",
        "Relationship Manager",
        "High-priority listing and social media push",
        "3-month validity"
      ],
    ...
    },
    {
      ...
      features: [
        "Everything in MoneyBack Plan",
        "Dedicated Field Assistant",
        "Top slot property visibility",
        "End-to-end buyer coordination"
      ],
  ...
  const workSteps = [
    { icon: <Users className="w-8 h-8" />, title: "LOOKING FOR A BUYER?", description: "Get verified buyer leads through any one of our assisted plans." },
    { icon: <UserCheck className="w-8 h-8" />, title: "THE HELPING HAND", description: "A dedicated Relationship Manager to guide and support you." },
    { icon: <Megaphone className="w-8 h-8" />, title: "MARKETING & PROMOTION", description: "Boost your visibility on listings and via social media promotion." },
    { icon: <Shield className="w-8 h-8" />, title: "FREEDOM FROM BOGUS CALLS", description: "Your RM handles all incoming calls and filters real buyers." },
    { icon: <CheckCircle className="w-8 h-8" />, title: "FILTER QUALIFIED BUYERS", description: "Only serious, qualified leads are forwarded to you." },
    { icon: <Zap className="w-8 h-8" />, title: "FASTER CLOSURE", description: "Sell your property quickly at a fractional cost (now ₹0)." }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {plans.map((plan, index) => (
              <Card key={index} className={`relative ${plan.color} border-2 hover:shadow-lg transition-shadow`}>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <p className="text-yellow-800 font-medium">
              <strong>Note:</strong> All plans are currently being offered at ₹0 as a <strong>limited-time launch offer</strong>. 
