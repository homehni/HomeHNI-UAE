                  ...
                  return (
                    <Card key={property.id} className="relative bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                      ...
                      <div className="absolute top-0 right-0 z-10">
                        <div className={`${property.listing_type === 'rent' ? 'bg-orange-500' : 'bg-blue-500'} text-white text-xs font-medium py-1 px-8 transform rotate-45 translate-x-5 translate-y-3`}>
