                    ...
                    <Card key={property.id} className="relative bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                      ...
                      <CardContent className="p-0">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="flex-shrink-0 ml-3 w-24 h-24 bg-gray-100 rounded-md flex items-center justify-center pr-3">
                            {(property.images && property.images.length > 0) ? (
                              ...
                              <div className="flex flex-col items-center justify-center">
                                <div className="relative w-20 h-20 bg-gray-200/70 rounded-md flex flex-col items-center justify-center cursor-pointer hover:bg-gray-300/70 transition-colors group">
