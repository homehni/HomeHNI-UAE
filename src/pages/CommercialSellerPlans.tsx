  ...
  const plans = [
    {
      ...
      color: "bg-red-600",
      features: [
        { text: "Photoshoot of your property", icon: Camera },
        { text: "Privacy of your phone number", icon: Shield },
        { text: "Property listing on website", icon: Globe },
        { text: "Basic property promotion", icon: TrendingUp },
        { text: "Call support from our team", icon: Phone }
      ]
    },
    {
      name: "Pro Plan",
      ...
      color: "bg-yellow-500",
      features: [
        { text: "Everything in Basic Plan", icon: CheckCircle },
        { text: "Relationship Manager (RM)", icon: Users },
        { text: "Property showings on your behalf", icon: Users },
        { text: "Premium photoshoot", icon: Camera },
        { text: "Social media marketing (FB & Insta)", icon: Share2 },
        { text: "Featured listing & promotion boost", icon: Zap },
        { text: "Verified Buyer Connect", icon: Shield },
        { text: "Price negotiation support", icon: Handshake },
        { text: "Legal & documentation assistance", icon: FileText }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-brand-red text-white py-20 pt-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="bg-yellow-400 text-black p-4 rounded-lg mb-8 inline-block">
            <p className="font-semibold">
              📢 All our premium seller services are currently FREE, but will soon become paid. Take advantage now!
            </p>
          </div>
          ...
          <Button 
            ...
            size="lg" 
            className="bg-white text-brand-red hover:bg-red-50 px-8 py-4 text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
          >
            See Seller Plans
          </Button>
        </div>
