    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <div className="pt-20 min-h-screen relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-blue-100 via-indigo-200 to-purple-200"></div>
          <div className="absolute inset-0 bg-gradient-to-tr from-red-100/30 via-orange-100/20 to-yellow-100/30"></div>
          
          {/* Decorative elements */}
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-brand-red/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/2 w-48 h-48 bg-purple-500/8 rounded-full blur-2xl transform -translate-x-1/2 -translate-y-1/2"></div>
