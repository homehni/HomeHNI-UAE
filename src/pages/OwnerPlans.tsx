  ...
  const plans = [
    {
      ...
      features: [
        "On-call assistance",
        "Plan validity: 45 days",
        "Guaranteed tenants or 100% money-back"
      ]
    },
    {
      ...
      color: "bg-blue-500",
      features: [
        "Includes everything in Relax Plan",
        "Property promotion on website",
        "Top slot listing (5x visibility)",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="gradient-red-maroon text-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <Link to="/tenant-plans" className="text-yellow-300 hover:text-yellow-100 underline">
