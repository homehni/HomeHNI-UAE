                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="h-12 file:h-10 file:mr-4 file:py-2 file:px-3 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-brand-red file:text-white hover:file:bg-brand-red-dark file:cursor-pointer cursor-pointer"
                    />
