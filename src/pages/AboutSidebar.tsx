                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3">
                          <a href="https://instagram.com/homehni" className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white hover:from-purple-600 hover:to-pink-600 transition-all">
                          ...
                          <a href="https://linkedin.com/company/homehni" className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
