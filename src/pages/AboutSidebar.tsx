                      ...
                      <div className="lg:pr-8">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-start">
                            <span className="text-gray-700 text-sm w-24 flex-shrink-0 mr-4">Write to us</span>
                            <a href="mailto:homehni8@gmail.com" className="text-blue-600 hover:underline text-sm">
                              homehni8@gmail.com
                            </a>
                          </div>
                          {/* <div className="flex items-start">
                            <span className="text-gray-700 text-sm w-24 flex-shrink-0 mr-4">Media Query</span>
                            <a href="mailto:media@homehni.com" className="text-blue-600 hover:underline text-sm">
                              media@homehni.com
                            </a>
                          </div> */}
                          <div className="flex items-start">
                            <span className="text-gray-700 text-sm w-24 flex-shrink-0 mr-4">Contact</span>
