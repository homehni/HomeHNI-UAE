...
const PaintingCleaning = () => {
  ...
  const paintingServices = [{
    ...
    desc: "Transform your home interiors with quality paint"
  }, {
    icon: <Paintbrush className="h-8 w-8 text-primary" />,
    title: "Exterior Painting",
    desc: "Weather-resistant exterior painting solutions"
  }, {
    icon: <Paintbrush className="h-8 w-8 text-primary" />,
    title: "Wall Texturing",
    desc: "Creative wall textures and designs"
  }, {
    icon: <Paintbrush className="h-8 w-8 text-primary" />,
    title: "Wood Polishing",
    desc: "Furniture and wood surface restoration"
  }];
  const cleaningServices = [{
    icon: <Sparkles className="h-8 w-8 text-primary" />,
    title: "Deep House Cleaning",
    desc: "Comprehensive home cleaning services"
  }, {
    icon: <Sparkles className="h-8 w-8 text-primary" />,
    title: "Kitchen Deep Cleaning",
    desc: "Thorough kitchen sanitization"
  }, {
    icon: <Sparkles className="h-8 w-8 text-primary" />,
    title: "Bathroom Cleaning",
    desc: "Professional bathroom deep cleaning"
  }, {
    icon: <Sparkles className="h-8 w-8 text-primary" />,
    title: "Post-Construction Cleaning",
    desc: "Clean-up after renovation work"
  }];
  const whyChooseUs = [{
    icon: <Shield className="h-12 w-12 text-primary" />,
    title: "Verified Professionals",
    desc: "All our service providers are background verified"
  }, {
    icon: <Clock className="h-12 w-12 text-primary" />,
    title: "Timely Service",
    desc: "On-time service delivery guaranteed"
  }, {
  ...
  return <div className="min-h-screen bg-background">
      ...
      backgroundImage: "url('/lovable-uploads/fbb0d72f-782e-49f5-bbe1-8afc1314b5f7.png')"
        ...
        }} className="text-4xl md:text-5xl font-bold mb-4 text-white drop-shadow-lg text-center">
            Painting & Cleaning Services
          </h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto text-white drop-shadow-md" style={{
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {paintingServices.map((service, index) => <Card key={index} className="hover:shadow-lg transition-shadow">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {cleaningServices.map((service, index) => <Card key={index} className="hover:shadow-lg transition-shadow">
                    <CardHeader className="flex flex-row items-center space-y-0 pb-2">
                      {service.icon}
                      <CardTitle className="ml-3 text-lg">{service.title}</CardTitle>
                    </CardHeader>
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {whyChooseUs.map((item, index) => <div key={index} className="flex items-start gap-4 p-6 bg-muted/50 rounded-lg">
                    {item.icon}
                    <div>
            ...
            <Card className="sticky top-24">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <Input placeholder="Mobile Number" type="tel" value={formData.mobile} onChange={e => setFormData({
                    ...formData,
                  ...
                  <div>
                    <Input placeholder="Location in Hyderabad" value={formData.location} onChange={e => setFormData({
                    ...formData,
                  ...
                  <div>
                    <Textarea placeholder="Describe your requirement in detail" value={formData.requirement} onChange={e => setFormData({
                    ...formData,
