...
<section className="py-16 px-4 bg-muted/10">
  <div className="container mx-auto">
    <div className="max-w-md mx-auto">
      <Card className="rounded-xl shadow-2xl bg-background border">
        <CardContent className="p-6">
          <h3 className="text-xl font-semibold text-foreground text-center mb-2">Got a property to be managed?</h3>
          <p className="text-sm text-muted-foreground mb-6 text-center">Just fill up the form & we will take care of the rest</p>
