            ...
            <CardContent className="p-6 md:p-8">
              ...
              <form className="space-y-5" onSubmit={e => {
                ...
                <div className="flex flex-col sm:flex-row gap-2 md:gap-3">
                  <Select name="projectType" required>
                    <SelectTrigger id="arch-project-type-mobile" className="h-10 md:h-12 bg-background">
                  ...
                  <Input id="arch-location-mobile" name="location" placeholder="Project Location" className="h-10 md:h-12 text-sm md:text-base bg-background" />
                </div>

                <div className="flex flex-col sm:flex-row gap-2 md:gap-3">
                  <Select name="country">
                    <SelectTrigger id="arch-country-mobile" className="h-10 md:h-12 bg-background">
                  ...
                  <Select name="state">
                    <SelectTrigger id="arch-state-mobile" className="h-10 md:h-12 bg-background">
